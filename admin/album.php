...
<head>
    ...
    <title>CRUD Album | UKK Nisa N</title>
            ...
            <div class="card mt-3 shadow rounded">
                ...
                <div class="card-body">
                    <form action="../config/aksi_album.php" method="post">
                        ...
                        <button type="submit" class="btn btn-primary mt-2" name="tambah"><i class="bi bi-person-plus"></i> Tambah Data</button>
                    </form>
                </div>
            </div>
        </div>
...
<button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#hapus<?php echo $data['album_id'] ?>"><i class="bi bi-trash3-fill"></i></button>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="../config/aksi_album.php" method="post">
        <input type="hidden" name="album_id" value="<?php echo $data['album_id'] ?>">
        Apakah anda yakin akan mengahpus data <strong> <?php echo $data['nama_album'] ?> ? </strong>
      </div>
      <div class="modal-footer">
