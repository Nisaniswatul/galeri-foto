...
if ($_SESSION['status'] != 'login') {
    ...
    exit; // Tambahkan exit untuk menghentikan eksekusi lebih lanjut setelah redirect.
}
...
<head>
    ...
    <title>Kategori | UKK Nisa N</title>
    <link rel="stylesheet" href="../assets/css/bootstrap.min.css">
    <link rel="stylesheet" href="../assets/css/font-awesome.min.css"> <!-- Perbaikan path ke font-awesome -->
...
<nav class="navbar navbar-expand-lg shadow rounded" style="background-color:#f5d3ce;">
  <div class="container">
    ...
    <div class="collapse navbar-collapse mt-2" id="navbarNavAltMarkup">
      ...
      <a href="../config/aksi_logout.php" class="btn shadow rounded" style="background-color:#ec9488;">Logout <i class="bi bi-box-arrow-right"></i></a>
    </div>
  </div>
</nav>
...
<div class="container mt-3">
    <div class="row">
        ...
        if (isset($_GET['album_id'])) {
            ...
            $query = mysqli_query($koneksi, "SELECT * FROM foto WHERE user_id='$userid' AND album_id='$albumid'");
        } else {
                ...
                <div class="card shadow p-2 rounded">
                    ...
                    <div class="card-footer text-center">
                        ...
                        if (mysqli_num_rows($ceksuka) == 1) { ?>
                            <a style="text-decoration:none" href="../config/proses_like.php?foto_id=<?php echo $data['foto_id'] ?>" type="submit" name="batal_suka"><i class="bi bi-heart-fill"></i></a>
                        <?php } else { ?>
                            <a style="text-decoration:none" href="../config/proses_like.php?foto_id=<?php echo $data['foto_id'] ?>" type="submit" name="suka"><i class="bi bi-heart"></i></a>
                        <?php }
